...
class User
{
    ...
    public function addUser(): void
    {
        ...
        $this->prepare('insert into user (lastName, firstName, mail, password, phone, addressLine1, addressLine2, postcode, city, country) values (:last_name, :first_name, :mail, :password, :phone, :address_line1, :address_line2, :postcode, :city, :country)', [
    ...
    {
        $this->prepare('update user where id = :id set (lastName = :last_name, firstName = :first_name, mail = :mail, password = :password, phone = :phone, addressLine1 = :address_line1, addressLine2 = :address_line2, postcode = :postcode, city = :city, country = :country, administrator = :administrator)', [
            ':id' => $pId,
            ':last_name' => $this->getLastName('je suis un titre'),
            ':first_name' => $this->getFirstName('je suis un content'),
            ':mail' => $this->getMail('je suis un titre'),
    ...
    {
        $this->prepare('deleted from user where id = :id set (lastName = :last_name, firstName = :first_name, mail = :mail, password = :password, phone = :phone, addressLine1 = :address_line1, addressLine2 = :address_line2, postcode = :postcode, city = :city, country = :country, administrator = :administrator)', [
            ':id' => $pId,
            ':last_name' => $this->getLastName('je suis un titre'),
            ':first_name' => $this->getFirstName('je suis un content'),
            ':mail' => $this->getMail('je suis un titre'),
