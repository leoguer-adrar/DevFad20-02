...
UPDATE Reservations SET `surname` = "Darkvador" WHERE `surname` = "Anakin" LIMIT 1;

-- -- #######################################################
-- -- #########--      SUPPRESSION
-- -- #####################################################

DELETE FROM Reservations WHERE surname = "Yoda" AND date_reservation = "2020-03-12" LIMIT 1;
